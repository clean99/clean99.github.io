...
- **Force you to understand your requirement**: If you don't know what your requirements are, you can't write tests, because tests are basically a translation from human word to script. And if you are using [Testing Best Practice Tdd](/2022/07/24/Testing-Best-Practice-Tdd/), **you need to write tests first according to your requirements**, that will be even better to force you to think about requirements first.
