...
const UI = {
  ...
  zh: {
    siteTagline: "工程师现场笔记",
    siteTitle: "许峰 Koh Hom — 工程师现场笔记",
    siteDescription: "许峰（Koh Hom）的工程现场笔记：浏览器级标签页系统、Web 性能、测试与 AI Agent 的项目复盘和长文。",
    heroTitle: ["我做能在生产环境里", "站得住", "的前端系统。"],
    heroLede:
      "我是许峰（Koh Hom），软件工程师，先后在 Shopee、蚂蚁集团、字节跳动和 TikTok 工作。这里是我的工程现场笔记：真实项目的复盘，以及关于 Web 性能、测试和 AI 辅助工程的长文。",
    heroPrimary: "精选作品",
    heroSecondary: "关于我",
    ...
    rss: "RSS",
    notes: (n: number) => `${n} 篇`,
    footerNote: "手写内容，Astro 构建，纯静态 HTML 交付。",
    notFound: "页面不存在",
