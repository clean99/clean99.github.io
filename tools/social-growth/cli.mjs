...
if (command === 'articles') {
  ...
  const result = await runSafeAutomationCycle({
    ...
    publicActionChecklistPath: args.publicActionChecklistOut || 'data/social-growth/public-action-checklist.md',
    ...
    loginHandoffPath: args.loginHandoffOut || 'data/social-growth/login-handoff.md',
    ...
    manualPublishKitDir: args.manualPublishKitDir || args.manualKitDir,
    manualPublishKitIndexOutPath: args.manualPublishKitIndex || args.manualKitIndex,
